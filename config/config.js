...
export const DATABASE = process.env.DATABASE || "proyecto-final-fullstack"
export const JWT_SECRET = process.env.JWT_SECRET || "mi_clave_secreta_para_pruebas123" //cambiarla por una fuerte
